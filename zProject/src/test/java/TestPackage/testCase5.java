...
public class testCase5 extends BasePageClass
{/*1) Open the browser
...
11) There should be a Reviews regarding that book the user clicked on*/
	...
	@Test
	public void verifyAddToKartBook()
	{
		homepage.ClickOnShopLink();
		shoppage.ClickOnHomeLink();
		List<WebElement> arival=homepage.ListOfNewArrivalsLink();
		utilityFilezProject.SelectFromList(arival, "Mastering JavaScript");
		bookpage.ClickOnaddToKartBtn();
		String displayItemInKart=bookpage.ClickOnviewKartLink();
		System.out.println("kart has value :"+displayItemInKart.isBlank());
		Assert.assertFalse(displayItemInKart.isBlank());
